class AddKebunModel {
  ...
  AddKebunModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['list_dokumen'] != null) {
      listDokumen = <ListDokumen1>[];
      json['list_dokumen'].forEach((v) {
        listDokumen!.add(new ListDokumen1.fromJson(v));
      });
    }
...
class ListDokumen1 {
  ...
  ListDokumen1({this.dokumenId, this.nomor, this.foto});

  ListDokumen1.fromJson(Map<String, dynamic> json) {
