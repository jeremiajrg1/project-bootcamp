class ProfilModel {
  ...
  ProfilModel({this.isSuccess, this.message, this.data, this.error});

  factory ProfilModel.withError(String error) => ProfilModel(error: error);
