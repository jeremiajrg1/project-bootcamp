class ListVerticalModel {
  bool? isSuccess;
  String? message;
  List<DataKebun>? data;
  String? error;

  ListVerticalModel({this.isSuccess, this.message, this.data, this.error});

  factory ListVerticalModel.withError(String error) => ListVerticalModel(error: error);

  ListVerticalModel.fromJson(Map<String, dynamic> json) {
